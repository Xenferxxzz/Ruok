...
ToggleButton.MouseButton1Click:Connect(function()
	game.CoreGui:FindFirstChild("NaoXz").Enabled = not game.CoreGui:FindFirstChild("NaoXz").Enabled
end)
...
coroutine.wrap(
    ...
    local CoreGui = {}
    local CheckCoreGui = {}
    local CoreGui = game:GetService("CoreGui"):FindFirstChild("NaoXz")
        if CoreGui then 
         CoreGui:Destroy() 
        elseif CoreGui then 
        local CheckCoreGui = not game.CoreGui:FindFirstChild("NaoXz").Enabled
